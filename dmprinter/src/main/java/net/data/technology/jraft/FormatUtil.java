...
public final class FormatUtil {
    ...
    private static final ThreadLocal<SimpleDateFormat> timeBy24H =
    ...
    /**
     * 转换 yyyy-MM-dd HH:mm:ss 字符串 变时间
     * 
     * @param timeStr
     * @return
    ...
    public static Date parseDateStr(String timeStr) throws ParseException {
        return timeBy24H.get().parse(timeStr);
    }

    /**
     * 格式化 yyyy-MM-dd HH:mm:ss 字符串
     * 
     * @param timeStr
     * @return
     * @throws ParseException
    ...
    public static String formatDateStr(Date date) {
        return timeBy24H.get().format(date);
    }
     ...
     */
    private static final ThreadLocal<SimpleDateFormat> millisTime_other =
            new ThreadLocal<SimpleDateFormat>() {
                @Override
                protected SimpleDateFormat initialValue() {
                    return new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS");
    ...
    /**
     * 获取yyyy-MM-dd hh:mm:ss.SSS格式时间
     * 
     * @param millis
     * @return yyyy-MM-dd hh:mm:ss.SSS
     */
    public static String formatMillisTimeOther(long millis) {
        return millisTime_other.get().format(new Date(millis));
    }
