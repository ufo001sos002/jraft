...
2211014：RDS实例初始化添加 失败 分配管理的实例 对象不存在(JSON 错误) 
2211015：RDS实例初始化添加 失败 分配管理的实例 对象 数据源初始化错误
**/
...
CODE >0 则code对应的单个具体错误码，message为错误信息
 CODE = -1 则message为JSON数组信息(即"message":[{code,message}] 其中code = 0 表示成功，>0表示对应错误码，message表示对应 实例ID字符串)
**/
2271011：RDS实例回收 失败(实例信息不存在)(仅当前分管节点回复，taskId 值可获取时回复)
2271012：RDS实例回收 失败(VIP移除失败)(仅当前分管节点回复，taskId 值可获取时回复)
...
CODE >0 则code对应的单个具体错误码，message为错误信息
 CODE = -1 则message为JSON数组信息(即"message":[{code,message}] 其中code = 0 表示成功，>0表示对应错误码，message表示对应 实例ID字符串)
**/
2281011：RDS实例移除 失败(实例信息不存在)(仅当前分管节点回复，taskId 值可获取时回复)
2281012：RDS实例移除 失败(VIP移除失败)(仅当前分管节点回复，taskId 值可获取时回复)
...
**/
2291000：RDS连接用户帐号变更 失败(捕获异常)
2291011：RDS连接用户帐号变更 失败(json信息有误)(仅Leader节点回复，taskId 值可获取时回复)
2291012：RDS连接用户帐号变更 失败(实例信息不存在)(仅Leader节点回复，taskId 值可获取时回复)
2291013：RDS连接用户帐号变更 失败(仅当前分管节点回复，taskId 值可获取时回复)
...
code = 0 表示成功，message内容忽略
**/
2301000：RDS IP白名单变更 失败(捕获异常)
2301011：RDS IP白名单变更 失败(json信息有误)(仅Leader节点回复，taskId 值可获取时回复)
2301012：RDS IP白名单变更 失败(白名单信息 不存在)(仅Leader节点回复，taskId 值可获取时回复)
2301013：RDS IP白名单变更 失败(实例信息 不存在)(仅Leader节点回复，taskId 值可获取时回复)
...
code = 0 表示成功，message内容忽略
**/
2321000：RDS实例数据库删除 失败(捕获异常)
2321010：RDS实例数据库删除 失败(json信息有误)(仅Leader节点回复，taskId 值可获取时回复)
2321011：RDS实例数据库删除 失败(实例不存在)(仅Leader节点回复，taskId 值可获取时回复)
...
code = 0 表示成功，message内容忽略
**/
2341000：RDS实例数据库添加 失败(捕获异常)(回复节点为Leader或监管节点，taskId 值可获取时回复)
2341011：RDS实例数据库添加 失败(json信息有误)(仅Leader节点回复，taskId 值可获取时回复)
2341012：RDS实例数据库添加 失败(实例不存在)(仅Leader节点回复，taskId 值可获取时回复)
2341013：RDS实例数据库添加 失败(用户相关信息 JSON异常)(仅Leader节点回复，taskId 值可获取时回复)
2341014：RDS实例数据库添加 失败(用户相关信息 用户不存在)(仅Leader节点回复，taskId 值可获取时回复)
...
code = 0 表示成功，message内容忽略
**/
2361010：RDS读写分离设置 失败(实例不存在)(仅监管节点回复，taskId 值可获取时回复)
2361011：RDS读写分离设置 失败(实例JSON信息不完全)(仅监管节点回复，taskId 值可获取时回复)
2361012：RDS读写分离设置 失败(实例	权重设置相关 JSON信息不完全)(仅监管节点回复，taskId 值可获取时回复)
